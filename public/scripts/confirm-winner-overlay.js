...
function openConfirm(del, mode, winner = null, scores = null) {
    ...
    if(mode == "bracket-single-elimination" || mode == "bracket-double-elimination")
        confirmWinnerMessage.innerHTML = "Please confirm, that winner of the match is <b>" + winner + "</b>"; 
    else if (mode == "bracket-kata-points")
        confirmWinnerMessage.innerHTML = "Please confirm, that entered scores are correct <b>" + scores.map((score) => "|" + score + "|") + "</b>"; 
